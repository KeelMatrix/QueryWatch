...
Write-Host "==> Applying Public API analyzer fixes (RS0016/RS0017/RS0037)..." -ForegroundColor Cyan
dotnet format analyzers $Solution --diagnostics RS0016,RS0017,RS0037 --no-restore --verbosity diagnostic
