...
- QueryWatch consumes the extracted `KeelMatrix.Redaction` and `KeelMatrix.Telemetry` 0.1.1 packages from NuGet.org; the JSON contracts remain internal and are bundled into `qwatch` rather than published separately.
