...
namespace KeelMatrix.QueryWatch.Providers.SmokeTests.MySQL {
    ...
    public class EfCoreTests {
        ...
        public void EfCore_Linq_Path_Is_Recorded() {
            ...
            DbContextOptionsBuilder<EfCtx> builder = new DbContextOptionsBuilder<EfCtx>()
            ...
            _ = db.Database.ExecuteSqlRaw("CREATE TABLE IF NOT EXISTS QW_Items (Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(200))");
